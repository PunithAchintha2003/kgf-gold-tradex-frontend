...
export function convertChartData(
  data: Array<{ date: string; open: number; high: number; low: number; close: number; volume: number; predicted_price?: number }>,
  ...
  return data.map(point => ({
    ...
    // Preserve predicted_price (it's still in USD, will be converted in Chart component when needed)
